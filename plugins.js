...
const {  state, saveCreds } =await useMultiFileAuthState(`./session`)
    ...
    const Wave = makeWASocket({
      ...
      browser: Browsers.ubuntu('Brave'), // for this issues https://github.com/WhiskeySockets/Baileys/issues/328
      auth: state,
...
ᴄᴏᴍᴍᴀɴᴅꜱ: 246\n
ᴠᴇʀꜱɪᴏɴ: 2.0\n
ᴄʀᴇᴀᴛᴏʀ: ꪶ♱ꫂ 𝐵𝐸𝐴𝐿𝑇𝐻 𝐺𝑈𝑌 ⛧\n
_ᴛʏᴘᴇ ${prefix}alive
 `
});


const rainbowColors = ['green', 'orange', 'red', 'purple'];
let index = 0;
...
async function getMessage(key){
        ...
        return {
            conversation: "WAVE-MD PENTESTER!"
        }
    }
