...
import { ExpirationTime, PrivacyLevel, } from "./interfaces.js";
...
const expirationTimeArr = Object.values(ExpirationTime);
export class AbstractPastebin {
    constructor(config, options) {
        ...
        if (options?.fetch) {
            __classPrivateFieldSet(this, _AbstractPastebin_fetch, options.fetch, "f");
        }
        if (options?.parseXML) {
            __classPrivateFieldSet(this, _AbstractPastebin_parseXML, options.parseXML, "f");
        }
        else {
            __classPrivateFieldSet(this, _AbstractPastebin_parseXML, (_xml) => {
                throw new Error("Not implemented!");
            }, "f");
        }
        if (isUndefined(config) || isNull(config)) {
            __classPrivateFieldSet(this, _AbstractPastebin_config, {}, "f");
            return;
        }
        let conf = config;
        ...
        __classPrivateFieldSet(this, _AbstractPastebin_debug, conf.debug === true, "f");
        delete conf.debug;
        __classPrivateFieldSet(this, _AbstractPastebin_config, Object.assign({
            api_dev_key: null,
            api_user_key: null,
            api_user_name: null,
    ...
    setDebug(debug) {
        __classPrivateFieldSet(this, _AbstractPastebin_debug, debug, "f");
    }
    /**
    ...
    async getPaste(id, isPrivate = false) {
        ...
        if (isPrivate) {
            const params = __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createParams).call(this, "show_paste");
            params.api_paste_key = ID;
            try {
                await __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createAPIuserKey).call(this);
                params.api_user_key = this.config.api_user_key;
                return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_postRequest).call(this, ENDPOINTS.APIRAW, params);
            }
            catch (error) {
                return Promise.reject(error);
            }
        }
        return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_getRequest).call(this, ENDPOINTS.RAW + ID);
    }
    /**
     * Create a paste
     *
    ...
    async createPaste(options) {
        ...
        const params = __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createParams).call(this, "paste");
        ...
        params.api_paste_private = privacy === PrivacyLevel.PUBLIC_USER
            ...
            : privacy;
        return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_postRequest).call(this, ENDPOINTS.POST, params);
    }
    /**
     * Delete a paste
     *
    ...
    async deletePaste(pasteID) {
        ...
        const params = __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createParams).call(this, "delete");
        params.api_paste_key = ID;
        try {
            await __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createAPIuserKey).call(this);
        }
    ...
    async listUserPastes(limit = 50) {
        ...
        const params = __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createParams).call(this, "list");
        ...
        params.api_user_key = this.config.api_user_key;
        return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_postAndParse).call(this, params, __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_parsePastes));
    }
    /**
    ...
    async getUserInfo() {
        ...
        const params = __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createParams).call(this, "userdetails");
        try {
            await __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_createAPIuserKey).call(this);
        }
        catch (error) {
        ...
        params.api_user_key = this.config.api_user_key;
        return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_postAndParse).call(this, params, __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_parseUser));
    }
    // Getters
    get debug() {
        return __classPrivateFieldGet(this, _AbstractPastebin_debug, "f");
    }
    get config() {
        return __classPrivateFieldGet(this, _AbstractPastebin_config, "f");
    }
    get hasDevKey() {
        return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_validateConfig).call(this, "api_dev_key") === false;
    }
}
_a = AbstractPastebin, _AbstractPastebin_config = new WeakMap(), _AbstractPastebin_fetch = new WeakMap(), _AbstractPastebin_parseXML = new WeakMap(), _AbstractPastebin_debug = new WeakMap(), _AbstractPastebin_instances = new WeakSet(), _AbstractPastebin_postAndParse = function _AbstractPastebin_postAndParse(params, parseFunc) {
    ...
    const missing = validateKeys.filter((key) => isUndefined(__classPrivateFieldGet(this, _AbstractPastebin_config, "f")[key]) ||
        __classPrivateFieldGet(this, _AbstractPastebin_config, "f")[key] === null ||
        __classPrivateFieldGet(this, _AbstractPastebin_config, "f")[key] === "");
    if (missing.length > 0) {
    ...
    const inValid = __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_validateConfig).call(this, "api_dev_key", "api_user_name", "api_user_password");
    ...
    return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_postRequest).call(this, ENDPOINTS.LOGIN, {
        api_dev_key,
        api_user_name,
        api_user_password,
    }).then((data) => {
    ...
    const data = __classPrivateFieldGet(this, _AbstractPastebin_parseXML, "f").call(this, xml);
    ...
    const { root: data } = __classPrivateFieldGet(this, _AbstractPastebin_parseXML, "f").call(this, `<root>${xml}</root>`);
    ...
    const init = __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_getRequestOptions).call(this, method, params);
    let timeout = null;
    if (this.requestTimeout > 0 && AbortController) {
        const abortController = new AbortController();
        init.signal = abortController.signal;
        timeout = setTimeout(() => {
            __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_debugger).call(this, ">>>>> aborting request");
            if (abortController) {
    ...
    try {
        const res = await __classPrivateFieldGet(this, _AbstractPastebin_fetch, "f").call(this, path, init);
        if (timeout !== null) {
            clearTimeout(timeout);
        }
        return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_handleResponse).call(this, res);
    }
    catch (error) {
        return Promise.reject(error);
    }
}, _AbstractPastebin_getRequest = function _AbstractPastebin_getRequest(path) {
    __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_debugger).call(this, ">>>>> getRequest", path);
    return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_abstractRequest).call(this, "GET", path);
}, _AbstractPastebin_postRequest = function _AbstractPastebin_postRequest(path, params) {
    __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_debugger).call(this, ">>>>> postRequest", path, params);
    return __classPrivateFieldGet(this, _AbstractPastebin_instances, "m", _AbstractPastebin_abstractRequest).call(this, "POST", path, params);
}, _AbstractPastebin_debugger = function _AbstractPastebin_debugger(...args) {
    if (__classPrivateFieldGet(this, _AbstractPastebin_debug, "f")) {
        console.log(...args);
    }
};
// VERSION
