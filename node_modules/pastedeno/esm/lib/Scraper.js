...
import { Evt as Event, to as toEvent } from "evt";
const ENDPOINTS = {
...
export class Scraper {
    ...
    constructor(opts, fetch) {
        ...
        _Scraper_events.set(this, new Event());
        ...
        _Scraper_scrapeAndFire.set(this, async (withTimeout = false) => {
            let errored = false;
            try {
                const data = await __classPrivateFieldGet(this, _Scraper_scrape, "f").call(this);
                __classPrivateFieldGet(this, _Scraper_instances, "m", _Scraper_fire).call(this, "scrape", data);
            }
            catch (error) {
                errored = true;
                __classPrivateFieldGet(this, _Scraper_instances, "m", _Scraper_fire).call(this, "error", error);
            }
            if (withTimeout) {
                if (errored && __classPrivateFieldGet(this, _Scraper_breakOnError, "f")) {
                    this.stop();
                }
                else {
                    __classPrivateFieldSet(this, _Scraper_timeout, setTimeout(() => __classPrivateFieldGet(this, _Scraper_scrapeAndFire, "f").call(this, true), __classPrivateFieldGet(this, _Scraper_intervalLength, "f")), "f");
                }
            }
        });
        _Scraper_scrape.set(this, async (limit) => {
            ...
            const limited = typeof limit !== "undefined" ? limit : __classPrivateFieldGet(this, _Scraper_limit, "f");
            const response = await __classPrivateFieldGet(this, _Scraper_fetch, "f").call(this, `${ENDPOINTS.SCRAPE}?limit=${limited}`);
            ...
            if (newPastes.length > 0) {
                ...
                newPastes.reverse().forEach((paste) => __classPrivateFieldGet(this, _Scraper_instances, "m", _Scraper_fire).call(this, "new", paste));
            }
        ...
        if (fetch) {
            __classPrivateFieldSet(this, _Scraper_fetch, fetch, "f");
        }
        ...
        __classPrivateFieldSet(this, _Scraper_intervalLength, options.intervalTime, "f");
        if (typeof options.limit !== "undefined" && (Number.isNaN(options.limit) ||
            ...
            __classPrivateFieldSet(this, _Scraper_limit, options.limit, "f");
        }
        if (typeof options.breakOnError !== "undefined") {
            __classPrivateFieldSet(this, _Scraper_breakOnError, options.breakOnError, "f");
        }
     ...
     */
    start() {
        if (__classPrivateFieldGet(this, _Scraper_timeout, "f") === null) {
            __classPrivateFieldGet(this, _Scraper_instances, "m", _Scraper_fire).call(this, "start");
            __classPrivateFieldGet(this, _Scraper_scrapeAndFire, "f").call(this, true);
        }
    }
    /**
     * Stops the scraper.
     */
    stop() {
        __classPrivateFieldGet(this, _Scraper_instances, "m", _Scraper_fire).call(this, "stop");
        if (__classPrivateFieldGet(this, _Scraper_timeout, "f") !== null) {
            clearTimeout(__classPrivateFieldGet(this, _Scraper_timeout, "f"));
            __classPrivateFieldSet(this, _Scraper_timeout, null, "f");
        }
    }
    /**
     * Scrapes pastes.
     ...
     */
    singleScrape(limit) {
        return __classPrivateFieldGet(this, _Scraper_scrape, "f").call(this, limit);
    }
    /**
     ...
     */
    getLast() {
        return __classPrivateFieldGet(this, _Scraper_scrape, "f").call(this, 1).then((data) => data[0]);
    }
    /**
     * Gets the raw paste.
     *
    ...
    getRaw(key) {
        ...
        return __classPrivateFieldGet(this, _Scraper_fetch, "f").call(this, `${ENDPOINTS.RAW}${realKey}`)
            .then((response) => {
            if (!response.ok) {
    ...
    getMeta(key) {
        const realKey = key
            .replace("https://scrape.pastebin.com/api_scrape_item.php?i=", "")
            .replace("https://pastebin.com/", "");
        return __classPrivateFieldGet(this, _Scraper_fetch, "f").call(this, `${ENDPOINTS.META}${realKey}`)
            .then((response) => {
            if (!response.ok) {
    ...
    on(eventName, handler) {
        __classPrivateFieldGet(this, _Scraper_events, "f").$attach(toEvent(eventName), handler);
    }
    get fetch() {
        return __classPrivateFieldGet(this, _Scraper_fetch, "f");
    }
}
_Scraper_fetch = new WeakMap(), _Scraper_events = new WeakMap(), _Scraper_limit = new WeakMap(), _Scraper_breakOnError = new WeakMap(), _Scraper_intervalLength = new WeakMap(), _Scraper_timeout = new WeakMap(), _Scraper_scrapeAndFire = new WeakMap(), _Scraper_scrape = new WeakMap(), _Scraper_instances = new WeakSet(), _Scraper_fire = function _Scraper_fire(eventName, ...args) {
    ...
    __classPrivateFieldGet(this, _Scraper_events, "f").post.call(__classPrivateFieldGet(this, _Scraper_events, "f"), callArgs);
};
// Version
